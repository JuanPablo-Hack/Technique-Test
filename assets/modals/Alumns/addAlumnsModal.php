    ...
    <div class="modal-dialog">
        <form class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col mb-3">
                        <label for="nameSlideTop" class="form-label">Last Name</label>
                        <input type="text" id="nameSlideTop" class="form-control" />
                    </div>
                </div>
                <div class="row g-2">
                    <div class="col mb-0">
                        <label for="emailSlideTop" class="form-label">Genre</label>
                    ...
                    <div class="col mb-0">
                        <label for="dobSlideTop" class="form-label">Birthday</label>
